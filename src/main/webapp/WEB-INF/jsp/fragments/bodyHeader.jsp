                    ...
                    <sec:authorize access="isAuthenticated()">
                        <form:form class="form-inline my-2" action="logout" method="post">
                            ...
                            <sec:authorize access="hasRole('ADMIN')">
                                ...
                                <a class="btn btn-info mr-1" href="restaurants"><spring:message code="restaurants.title"/></a>
                                <a class="btn btn-info mr-1" href="menusList"><spring:message code="menu.title"/></a>
                            </sec:authorize>
                            <a class="btn btn-info mr-1" href="profile"><sec:authentication property="principal.user.name"/> <spring:message code="app.profile"/></a>
